...
namespace WCell.Util.Data
{
	...
	{
		private const int DynamicMaximumMembers = 50;

		public const string CacheGetterName = "GetAllDataHolders";

		private string m_name, m_DependingFieldName;
		private readonly DataHolderAttribute m_Attribute;
		private readonly Type m_Type;
		private IProducer m_defaultProducer;
		private Dictionary<object, IProducer> m_dependingProducers;
