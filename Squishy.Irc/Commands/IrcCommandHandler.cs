...
namespace Squishy.Irc.Commands
{
	...
	public class IrcCommandHandler
	{
		...
		private static IDictionary<string, Command> commandsByAlias;
		...
		/// </summary>
		public static IDictionary<string, Command> CommandsByAlias
		{
		...
		{
			commandsByAlias = new Dictionary<string, Command>(StringComparer.InvariantCultureIgnoreCase);
