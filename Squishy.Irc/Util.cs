...
namespace Squishy.Irc
{
	public class Util
	{
		...
		/// <summary>
		/// Returns a local endpoint with a random port (for example for Dcc).
		/// </summary>
		public static IPEndPoint LocalEndPoint
		{
			get { return new IPEndPoint(localAddr, 0); }
		}
		...
		/// <summary>
		/// Sets the Ip address for Util.LocalEndPoint which is used among other things for Dcc.
		/// </summary>
		public static void SetLocalAddress(IPAddress addr)
		{
			localAddr = addr;
		}
